...
export default function FamilyPanel({
  ...
  const [resolvedUid, setResolvedUid] = useState(
    auth.currentUser?.uid || userId || null,
  );
  ...
  const handleRegen = async () => {
    ...
    try {
      ...
      const updates = {
        ...
        [`families/${familyId}/inviteCode`]: newCode,
      };
      ...
      <div style={styles.wrap}>
        <div style={styles.card}>
          ...
          <p style={styles.emptySub}>
            You're using FamilyTrack EV as a guest.
            <br />
    ...
    <div style={styles.wrap}>
      ...
      <div style={styles.header}>
        ...
        <span
          style={{
            ...styles.roleBadge,
            borderColor: ROLE_META[userRole]?.color || "#666",
            color: ROLE_META[userRole]?.color || "#999",
          }}
        >
          {ROLE_META[userRole]?.icon || "👤"}{" "}
          {ROLE_META[userRole]?.label || userRole || "Unknown"}
        </span>
      </div>
      ...
      <div style={styles.section}>
        ...
        <p style={styles.sectionHint}>
          Share this with family members to join your group.
        </p>
          ...
          <>
            ...
            <div style={styles.codeActions}>
              <button
                style={
                  copied
                    ? { ...styles.actionBtn, ...styles.actionBtnSuccess }
                    : styles.actionBtn
                }
                onClick={handleCopy}
              >
              ...
              return (
                <div key={uid} style={styles.memberRow}>
                  ...
                  <div style={styles.memberInfo}>
                    ...
                    {profile?.email && (
                      <span style={styles.memberEmail}>{profile.email}</span>
                    )}
                  </div>
                  <span
                    style={{
